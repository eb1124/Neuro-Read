...
app.add_middleware(
    ...
    allow_origins=["https://neuro-read-rouge.vercel.app"]
...
from app.routes.assistive.define import router as assistive_define_router
app.include_router(assistive_define_router)
